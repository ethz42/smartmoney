          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center space-x-8">
              <Link href="/" className="flex items-center space-x-2">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-BGWDK69C3rIvcj1IQlRnW8jW32UXOW.png"
                  alt="PUMP.NEWS"
                  width={32}
                  height={32}
                  className="h-8 w-8"
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            <Image
              ...
              className="mx-auto"
            />
            <h1 className="text-2xl text-gray-300">Your Social Radar for Meme Coins</h1>
          </div>
